...
#include <jni.h>
/* Header for class ru_albemuth_jcuda_jcusegsort_Sorting */

#ifndef _Included_ru_albemuth_jcuda_jcusegsort_Sorting
#define _Included_ru_albemuth_jcuda_jcusegsort_Sorting
#ifdef __cplusplus
extern "C" {
#endif
/*
